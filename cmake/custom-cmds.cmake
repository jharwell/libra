...
function(libra_config_summary)
  ...
  message(STATUS "Build tests...........................: LIBRA_TESTS=${LIBRA_TESTS} [make unit-tests]")
  ...
  message(STATUS "Enable API doc building...............: LIBRA_DOCS=${LIBRA_DOCS} [make apidoc]")
  ...
  message(STATUS "Static analysis.......................: LIBRA_ANALYSIS=${LIBRA_ANALYSIS} [make {check-all,cppcheck-all,static-check-all,tidy-check-all}]")
  message("")
  message("--------------------------------------------------------------------------------")
