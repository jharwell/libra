...
set(_LIBRA_COMMON_COMPILE_OPTIONS
    ...
    ${_LIBRA_COVERAGE_COMPILE_OPTIONS})
...
foreach(target ${_LIBRA_TARGETS})
  ...
  foreach(_opt IN LISTS _LIBRA_C_LINK_OPTIONS)
    target_link_options(${target} PUBLIC $<$<LINK_LANGUAGE:C>:${_opt}>)
  endforeach()
  foreach(_opt IN LISTS _LIBRA_CXX_LINK_OPTIONS)
    target_link_options(${target} PUBLIC $<$<LINK_LANGUAGE:CXX>:${_opt}>)
  endforeach()
  ...
  endforeach()
  if(opt_genex)
    target_link_options(${target} PUBLIC ${opt_genex})
  endif()
endforeach()
