...
# Diagnostic Options
#
# 2259 - warnings about converting uint16_t to uint8_t losing precision 10382 -
# Telling me what option xHost was setting 2015 - One of the effective C++
# warnings for always using // for comments 2012 - Another effective C++
# warnings for not using #defines 11071 - Warnings about inlines not being
# honored 1476 - Tail padding of a base class 1505 - Size of class affected by
# tail padding 383 - Value copied to temporary; reference to temporary used 411
# - Class/struct defines no constructor to initialize member 3180 - Warnings
# about unknown OpenMP pragmas 177,869,593 - Unused variable/parameters
# ##############################################################################
...
# Checking Options
# ##############################################################################
set(MSAN_OPTIONS -fno-omit-frame-pointer -check-pointers=rw
                 -check-pointers-dangling=all -check-pointers-undimensioned)
...
# Profiling Options
# ##############################################################################
set(BASE_PGO_GEN_OPTIONS -prof-gen=srcpos,globaldata, -prof-gen-sampling)
set(BASE_PGO_USE_OPTIONS -prof-use -prof-use-sampling)

if(LIBRA_MT)
  set(BASE_PGO_GEN_OPTIONS "${BASE_PGO_GEN_OPTIONS}" -prof-gen=threadsafe)
else()
  set(BASE_PGO_GEN_OPTIONS "${BASE_PGO_GEN_OPTIONS}" -profile-functions
...
# Reporting Options
# ##############################################################################
set(BASE_REPORT_OPTIONS -qopt-report-phase=all -qopt-report=4
