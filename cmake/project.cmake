...
# Set policies
set_policy(CMP0028 NEW) # ENABLE CMP0028: Double colon in target name means
                        # ALIAS or IMPORTED target.
...
set_policy(CMP0063 NEW) # ENABLE CMP0063: Honor visibility properties for all
                        # target types.
set_policy(CMP0074 NEW) # ENABLE CMP0074: find_package uses <PackageName>_ROOT
                        # variables.
...
if(${LIBRA_ANALYSIS})
  ...
  if(NOT ${PROJECT_NAME}_CHECK_LANGUAGE)
    message(
      WARNING
        "Static analysis enabled but ${PROJECT_NAME}_CHECK_LANGUAGE not set")
  else()
    ...
    elseif("${${PROJECT_NAME}_CHECK_LANGUAGE}" STREQUAL "CXX")
      ...
      message(
        FATAL_ERROR "Bad static analysis language for project: must be [C,CXX]")
    endif()
