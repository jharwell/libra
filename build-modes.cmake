...
################################################################################
set(CDFLAGS "")
foreach(arg ${C_DIAG_OPTIONS} ${C_PARALLEL_OPTIONS} ${C_CHECK_OPTIONS} ${C_REPORT_OPTIONS} ${CC_DEV_DEFS} ${EXTRA_FLAGS})
...
set(CXXDFLAGS "")
foreach(arg ${CXX_DIAG_OPTIONS} ${CXX_PARALLEL_OPTIONS} ${CXX_CHECK_OPTIONS} ${CXX_REPORT_OPTIONS} ${CC_DEV_DEFS} ${EXTRA_FLAGS})
...
################################################################################
set(OPTCFLAGS "")
foreach(arg ${C_OPT_OPTIONS} ${C_DIAG_OPTIONS} ${C_PARALLEL_OPTIONS} ${C_REPORT_OPTIONS} ${CC_OPT_DEFS} ${EXTRA_FLAGS})
...
set(OPTCXXFLAGS "")
foreach(arg ${CXX_OPT_OPTIONS} ${CXX_DIAG_OPTIONS} ${CXX_PARALLEL_OPTIONS} ${CXX_REPORT_OPTIONS} ${CC_OPT_DEFS} ${EXTRA_FLAGS})
